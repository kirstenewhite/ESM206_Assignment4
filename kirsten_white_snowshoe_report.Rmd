...
This study explores showshoe hares (Lepus americanus) from data physically collected in Bonanza Creek Experimental Forest in Alaskan boreal forests from 1999 - 2012. The study conducted capture-recapture of snowshoe hares to evaluate population fluctuations within the keystone prey species. In this study, trap count, weight, and site data on juvenile hares is explored. 
...
```
# **Data & Analysis** 
In this report, juvenile snowshoe hare weight and count data is explored, analyzed, and visualized by sex and site. This data was collected from the Bonanza Creek LTER, part of the US Long Term Ecological Research Network, between 1998 and 2012. 
...
**Figure 1**: Total number of juvenile hares trapped per year from 1998 through 2012 is indicated. 
...
```
As seen in **Table 1**, juvenile hares trapped over a 12 year span varied greatly. More juveniles were trapped at the begininning of the study and steadily decreased over time. Counts ranged from a maximum of 126 trapped in a year to a minimum of 2 trapped in a year. The mean number of juveniles trapped is 31.5 while the median value is much lower at 18.5 juveniles trapped per year. 


# **Part 2: Juvenile Hare Weights**
In this section, juvenile snowshoe hare weights are compared by sex and site then findings are represented visually in a graph. 
...
As seen in **Figure 2**, there is a significantly higher sample size associated with the Bonanza Riparian site compared to the other two sites. Overall, the distribution, or spread, of weights is large. 
...
- The **R^2^ value** of `r round(hfoot_weight_lm_out$r.squared, 1)` means that 30% of the variance in hind foot length length is explained by weight. 
